...
if __name__ == "__main__":
    ...
    stocks_df = spark.read.csv("hdfs://devenv/user/spark/spark_sql_101/data/stocks_without_header.csv",
    ...
    result_df.show()
    result_df.write.json("hdfs://devenv/user/spark/spark_sql_101/data/stocks_in_json3")
